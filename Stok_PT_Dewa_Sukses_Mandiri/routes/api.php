...
Route::get('/penyimpananbarang', [API_LaporanBarangController::class,'index']);
Route::post('/penyimpananbarang/{id}', [API_LaporanBarangController::class,'update']);
Route::post('/penyimpananbarang', [API_LaporanBarangController::class,'store']);
Route::delete('/penyimpananbarang/{id}', [API_LaporanBarangController::class,'destroy']);
